# Bootstrap adapter for Gemini CLI

This file provides Gemini CLI repository bootstrap compatibility only. It is not a Playbook authority, does not create a second current-state policy source, and does not change repository permissions or task authorization.
