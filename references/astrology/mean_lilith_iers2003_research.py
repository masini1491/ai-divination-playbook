"""REFERENCE-ONLY AST-P1-020 candidate implementation.
...
Time argument:
    TT Julian centuries since J2000.0 (TT is used in place of TDB as allowed
    for these IERS fundamental arguments).
