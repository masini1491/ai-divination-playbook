...
Method-scoped backlog topology與 coordination-write path contract → `REPOSITORY_ARCHITECTURE.md` §2.7；generic semantics仍由 activated shared `AI_CONTEXT.md` / `REPOSITORY_EXECUTION.md` 擁有。
