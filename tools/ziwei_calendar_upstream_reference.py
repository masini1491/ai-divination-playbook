#!/usr/bin/env python3
"""Pinned upstream Gregorian→lunar reference oracle for Zi Wei build/parity validation.
...
PROVIDER_ID = "ziwei-calendar-lunar-python-reference"
...
def normalize_gregorian_birth(data: GregorianBirthInput) -> dict[str,Any]:
    ...
    return {
        ...
        "provider":{
            ...
            "authority":"BUILD-PARITY REFERENCE ONLY / NOT PRODUCTION",
        },
        "calendar_profile":{
