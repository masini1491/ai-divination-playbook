...
PROJECT_PATHS=(
 ...
 "tools/ziwei_decadal_provider.py",
 "tools/ziwei_yearly_provider.py",
 "tools/ziwei_monthly_provider.py",
 "schemas/ziwei/ZIWEI_DYNAMIC_REQUEST_V2.schema.json",
 "schemas/ziwei/ZIWEI_DYNAMIC_RESULT_V2.schema.json",
 "schemas/ziwei/ZIWEI_DYNAMIC_REQUEST_V3.schema.json",
 "schemas/ziwei/ZIWEI_DYNAMIC_RESULT_V3.schema.json",
 "schemas/ziwei/ZIWEI_DYNAMIC_REQUEST_V4.schema.json",
 "schemas/ziwei/ZIWEI_DYNAMIC_RESULT_V4.schema.json",
