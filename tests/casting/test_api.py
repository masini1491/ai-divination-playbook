...
class CastApiContractTests(unittest.TestCase):
    def test_accepts_minimal_tarot_request(self):
        self.assertEqual(cast.validate_cast_request({"method": "tarot", "count": 3}), {"method": "tarot", "count": 3, "repeat": 1})
    ...
    def test_execute_cast_uses_deployment_commit_and_compact_projection(self):
        ...
        generate.assert_called_once_with("tarot", count=5, repeat=4, source_commit="deadbeef")
